...
def relaxation_gurobi(X, Y, W, C, mu, nu, l, rho):
    ...
    print("SHAPE l",l)
    print("SHAPE X_mul",X_mul.shape)
    print("SHAPE P",P.shape)
    print("SHAPE C",C.shape)
    print("SHAPE (D@P)",(D@P).shape)
    print("SHAPE (C@P)",(C@P).shape)
    # Set objective
    ...
    test = -l*X_mul
    test1 = D@P
    print("SHAPETEST",(test1@test).shape)
    m.setObjective((C @ P)  +  (test1@test) ,GRB.MINIMIZE)#- l * X_mul, GRB.MINIMIZE)
